...
const translations: Record<string, Record<Locale, string>> = {
  ...
  'models.loading': { en: 'Loading cached models...', sv: 'Laddar cachade modeller...' },
  'models.info': {
  ...
  // Upload panel
  'upload.drop': { en: 'Drop images here or click to upload', sv: 'Släpp bilder här eller klicka för att ladda upp' },
  'upload.hint1': {
  ...
  'toolbar.transcriptions': { en: 'Toggle transcriptions', sv: 'Visa/dölj transkriptioner' },
  'toolbar.boxes': { en: 'Show line boxes', sv: 'Visa radbegränsningar' },
  'toolbar.hideBoxes': { en: 'Hide line boxes', sv: 'Dölj radbegränsningar' },
  'toolbar.textOverlay': { en: 'Show transcriptions on image', sv: 'Visa transkriptioner på bilden' },
  'toolbar.hideTextOverlay': { en: 'Hide text overlay', sv: 'Dölj textöverlägg' },
  'toolbar.selectMode': { en: 'Draw region to transcribe', sv: 'Rita region att transkribera' },
  'toolbar.panMode': { en: 'Switch to pan mode', sv: 'Byt till panoreringsläge' },
  'toolbar.transcribe': { en: 'Transcribe page', sv: 'Transkribera sida' },
  'toolbar.retranscribe': { en: 'Re-transcribe page', sv: 'Transkribera sida igen' },
  ...
  // Export
  'export.title': { en: 'Export transcriptions', sv: 'Exportera transkriptioner' },
  ...
  'gpu.connectGpu': { en: 'Connect to GPU server', sv: 'Anslut till GPU-server' },
  'gpu.connected': { en: 'Connected', sv: 'Ansluten' },
  'gpu.failed': { en: 'Failed to connect', sv: 'Kunde inte ansluta' },
  'gpu.disconnect': { en: 'Disconnect (use WASM)', sv: 'Koppla från (använd WASM)' },
  'gpu.local': { en: 'Using local WASM inference', sv: 'Använder lokal WASM-inferens' },

  // Transcription panel
  'transcription.pressPlay': { en: 'Press', sv: 'Tryck' },
  'transcription.toTranscribe': { en: 'to transcribe this page', sv: 'för att transkribera denna sida' },
  'transcription.filter': { en: 'Filter transcriptions...', sv: 'Filtrera transkriptioner...' },
  'transcription.ready': { en: 'Ready', sv: 'Klar' },
  'transcription.noRegions': { en: 'No regions detected', sv: 'Inga regioner hittades' },
