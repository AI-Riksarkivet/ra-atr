...
func (m *RaAtr) PrettierCheck(ctx context.Context, source *dagger.Directory) (string, error) {
...
func (m *RaAtr) SvelteCheck(ctx context.Context, source *dagger.Directory) (string, error) {
	return m.buildFrontendDev(source).
...
func (m *RaAtr) Checks(ctx context.Context, source *dagger.Directory) error {
